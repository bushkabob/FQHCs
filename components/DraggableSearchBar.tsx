...
const DraggableSearchBar: React.FC = () => {
						...
						<GlassContainer>
							<GlassView style={{width: "100%", alignItems: "center", height: "100%", borderRadius: 100}} >
								...
								<Pressable onPress={()=>TextInputRef.current?.focus()} style={{alignSelf: "stretch"}} >
									<GlassView isInteractive tintColor="#d3d3d3" style={{ flexDirection: "row", alignSelf: "stretch", alignItems: "center", height: 40, marginHorizontal: 10, marginBottom: 10, borderRadius: 80}} >
